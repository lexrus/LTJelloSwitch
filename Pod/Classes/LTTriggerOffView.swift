...
public class LTTriggerOffView: UIView
{
    ...
    public override func drawRect(rect: CGRect) {
        ...
        //// Color Declarations
        let tintColor = UIColor.darkGrayColor()
        ...
        let textTextContent = NSString(string: "Off")
        let textStyle = NSMutableParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        textStyle.alignment = NSTextAlignment.Left
        
        let textFontAttributes = [NSFontAttributeName: UIFont.systemFontOfSize(UIFont.smallSystemFontSize()), NSForegroundColorAttributeName: titleColor, NSParagraphStyleAttributeName: textStyle]
